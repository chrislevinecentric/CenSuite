...
describe('Message', () => {
  ...
  it('Should render a title with subtitle', () => {
    render(<Message header="title" subTitle="subtitle"/>);

    expect(screen.getByRole('alert').className).to.include('rs-message-has-subtitle');
    expect(screen.getByRole('alert')).to.text('title');
    expect(screen.getByRole('alert')).to.text('subTitle');
  });
  ...
  it('Should have border', () => {
    render(<Message border />);
    expect(screen.getByRole('alert').className).to.include('rs-message-border');
  });
